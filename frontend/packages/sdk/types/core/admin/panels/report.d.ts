...
export declare const REPORTS_TAB = "reports";
/**
 ...
 */
export declare function reportUrl(source: PanelSource, panelId: string, period?: string): string;
/** The catalogue of reports, with no panel open. */
export declare function reportsIndexUrl(): string;
