...
export declare const DASHBOARD_KEY: readonly ["admin-dashboard"];
/**
 ...
 */
export declare function useDashboard(period: string): import("@tanstack/react-query").UseQueryResult<NoInfer<DashboardData>, Error>;
