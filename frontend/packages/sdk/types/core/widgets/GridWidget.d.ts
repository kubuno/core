...
declare function GridWidget({ widget, pos, editMode, isLanding, config, onConfigChange, onDragStart, onResizeStart, onRemove, onManualResize, }: Props): React.JSX.Element;
