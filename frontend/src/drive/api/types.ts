// Shared data shapes of the drive API (files, folders, shares, versions,
// activity, remote mounts…). Kept in one place so every domain slice and every
// consumer of `@kubuno/drive` sees the exact same types.
