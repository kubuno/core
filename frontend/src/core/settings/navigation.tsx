...
import { Key, Shield, User, Laptop, Bell, Palette, Download, ChevronRight, type LucideIcon } from 'lucide-react'
...
export const SETTINGS_NAV: { id: Tab; labelKey: string; defaultLabel: string; Icon: LucideIcon }[] = [
