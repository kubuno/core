      ...
      {menus.map(menu => (
        <div key={menu.label}>
          <button
            ...
            style={{ fontSize: 12, padding: '2px 8px', borderRadius: 4, color: dark ? '#cccccc' : 'var(--kbn-ws-text, #202124)', background: openMenu === menu.label ? hoverBg : undefined, transition: 'background 0.1s' }}
          >
            {menu.label}
          </button>
